  ...
  return (
    <div 
      className={clsx(
        ...
        'prose-blockquote:border-l-4 prose-blockquote:border-zinc-300 prose-blockquote:pl-4 dark:prose-blockquote:border-zinc-700',
        ...
        'prose-ul:my-3 prose-ul:pl-5 prose-li:my-1 prose-li:pl-0',
